...
const targetTag = 'v1.2.0';
const releaseName = 'AI Widget v1.2.0 - Mise à jour Obligatoire';
const releaseNotes = `## 🚀 AI Widget v1.2.0 - Mise à jour de Sécurité Obligatoire
...
async function uploadToRepo(repo) {
  console.log(`\n🔍 Vérification des releases sur [${repo}] pour ${targetTag}...`);
...
async function main() {
  ...
  console.log('\n🎉 Téléversement v1.2.0 public terminé !');
}
